...
export default class PluralKit {
  ...
  async getSwitches (id: SystemID, limit = 100, before?: DateTime) {
    ...
    return this.requestParsed(
      `https://api.pluralkit.me/v2/system/${id}/switches`,
      params,
      'GET',
      Schema.Array(Switch)
    )
  ...
  async getSwitch (systemId: SystemID, switchId: UUID): Promise<Switch> {
    ...
    return this.requestParsed(
      `https://api.pluralkit.me/v2/system/${systemId}/switches/${switchId}`,
      {},
      'GET',
      Switch
    )
  ...
  async getFronters (systemId: SystemID) {
    ...
    // TODO: Narrowed type for method (members = Array<Member>)
    return this.requestParsed(
      `https://api.pluralkit.me/v2/system/${systemId}/fronters`,
      {},
      'GET',
      Switch
    )
  ...
  async createSwitch (systemId: SystemID, members: Array<MemberID | UUID>, timestamp?: DateTime) {
    ...
    return this.requestParsed(
      `https://api.pluralkit.me/v2/system/${systemId}/switches`,
      {},
      'POST',
      Switch,
      data
  ...
  async updateSwitchMembers (
    ...
    return this.requestParsed(
      `https://api.pluralkit.me/v2/system/${systemId}/switches/${switchId}/members`,
      {},
      'PATCH',
      Switch,
      { members }
