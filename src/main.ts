...
export default class PluralKit {
  ...
  async getSwitches (systemRef: SystemRef, limit = 100, before?: Date) {
    ...
    return this.requestParsed(
      `https://api.pluralkit.me/v2/system/${systemRef}/switches`,
      params,
      'GET',
      z.array(Switch)
    )
  ...
  async getSwitch (systemRef: SystemRef, switchId: SwitchID): Promise<Switch> {
    ...
    return this.requestParsed(
      `https://api.pluralkit.me/v2/system/${systemRef}/switches/${switchId}`,
      {},
      'GET',
      Switch
    )
  ...
  async getFronters (systemRef: SystemRef) {
    // TODO: Narrowed type for method (members = Array<Member>)
    return this.requestParsed(
      `https://api.pluralkit.me/v2/system/${systemRef}/fronters`,
      {},
      'GET',
      Switch
    )
  ...
  async updateSwitchMembers (
    ...
    return this.requestParsed(
      `https://api.pluralkit.me/v2/system/${systemRef}/switches/${switchId}/members`,
      {},
      'PATCH',
      Switch,
      { members: memberRefs }
